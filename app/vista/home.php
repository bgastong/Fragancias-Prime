...
<section id="heroCarousel" class="hero-carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="<?= htmlspecialchars(asset_url('img/Carrousel-Home/scandal.webp'), ENT_QUOTES) ?>"
                alt="Fragancia Scandal"
                class="carousel-img">
        </div>

        <div class="carousel-item">
            <img src="<?= htmlspecialchars(asset_url('img/Carrousel-Home/d&g.webp'), ENT_QUOTES) ?>"
                alt="Dolce & Gabbana"
                class="carousel-img">
        </div>

        <div class="carousel-item">
            <img src="<?= htmlspecialchars(asset_url('img/Carrousel-Home/swy.webp'), ENT_QUOTES) ?>"
                alt="Fragancia SWY"
                class="carousel-img">
        </div>
...
<section class="productos-section">
    <div class="container py-5">
        <h2 class="text-center mb-4"><?= !empty($busqueda) ? 'Resultados de búsqueda' : 'Productos Destacados' ?></h2>
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="producto-card">
                            <div class="producto-img-container">
                                ...
                                $rutaImagen = product_image_url($producto, 'Fragancia sin imagen');
                                ?>
                                <img src="<?= htmlspecialchars($rutaImagen) ?>"
                                    alt="<?= htmlspecialchars($producto['prodetalle']) ?>"
                                    class="producto-img"
                                    onerror="this.onerror=null;this.src='<?= htmlspecialchars(placeholder_image_url('Fragancia sin imagen'), ENT_QUOTES) ?>'">
                            </div>
